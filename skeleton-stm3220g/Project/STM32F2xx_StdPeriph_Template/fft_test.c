...
static FLOAT_TYPE inverse_real[FFT_LENGTH];
static FLOAT_TYPE inverse_imag[FFT_LENGTH];
static FLOAT_TYPE out_i[FFT_LENGTH];
static FLOAT_TYPE out_r[FFT_LENGTH];
static FLOAT_TYPE mag[FFT_LENGTH];
...
bool float_compare(FLOAT_TYPE a, FLOAT_TYPE b, FLOAT_TYPE epsilon)
{
	return fabs(a - b) < epsilon;
}

// Utility function to verify that two buffers contain the same values
bool buffer_compare(FLOAT_TYPE *buf1, FLOAT_TYPE *buf2, int n)
{
	for (int i = 0; i < n; i++)
	{
...
void print_buffer(FLOAT_TYPE *buf, uint8_t n)
{
	printf("[ ");
	for (int i = 0; i < n; i++)
	{
...
void fft_test(FFT_signals_t *signals, FLOAT_TYPE *expected_real_output, FLOAT_TYPE *expected_imag_ouput, FLOAT_TYPE *expected_magnitude, bool *test_results, int n)
{
...
bool test_1()
{
	FLOAT_TYPE input_real[4] = {1, 0, 0, 0};
	FLOAT_TYPE input_imag[4] = {0, 0, 0, 0};
	FLOAT_TYPE expected_output_real[4] = {1, 1, 1, 1};
	FLOAT_TYPE expected_output_imag[4] = {0, 0, 0, 0};
	FLOAT_TYPE expected_magnitude[4] = {1, 1, 1, 1};
...
bool test_2()
{
	FLOAT_TYPE input_real[64] = {0.000000, 0.099568, 0.198146, 0.294755, 0.388435, 0.478254, 0.563320, 0.642788, 0.715867, 0.781831, 0.840026, 0.889872, 0.930874, 0.962624, 0.984808, 0.997204, 0.999689, 0.992239, 0.974928, 0.947927, 0.911506, 0.866025, 0.811938, 0.749781, 0.680173, 0.603804, 0.521435, 0.433884, 0.342020, 0.246757, 0.149042, 0.049846, -0.049846, -0.149042, -0.246757, -0.342020, -0.433884, -0.521435, -0.603804, -0.680173, -0.749781, -0.811938, -0.866025, -0.911506, -0.947927, -0.974928, -0.992239, -0.999689, -0.997204, -0.984808, -0.962624, -0.930874, -0.889872, -0.840026, -0.781831, -0.715867, -0.642788, -0.563320, -0.478254, -0.388435, -0.294755, -0.198146, -0.099568, -0.000000};
	FLOAT_TYPE input_imag[64] = {0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000