/**
  ...
  *     "stm324x7i_eval_audio_codec.c" provided by STMicroelectronics for
  *     the STM32F4xx family (in folder Utilities\STM32_EVAL\STM324x7I_EVAL).
...
#ifndef __STM324x7I_AUDIOCODEC_H
#define __STM324x7I_AUDIOCODEC_H
...
/* Uncomment the following line to use the default Codec_TIMEOUT_UserCallback() 
   function implemented in stm324x7i_evel_audio_codec.c file.
...
/* Codec_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm324x7i_audio_codec.h file.
...
/**
  * @}
  */  
#endif /* __STM324x7I_AUDIOCODEC_H */
