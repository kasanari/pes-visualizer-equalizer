...
#ifndef __STM324x7I_AUDIO_RECORDER_H
#define __STM324x7I_AUDIO_RECORDER_H
...
/* Optional data processing functions (Digital Filtering, Encoding ...).
   ...
   file stm324x7i_eval_audio_conf.h  */
...
#endif /*__STM324x7I_AUDIO_RECORDER_H */
